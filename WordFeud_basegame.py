...
tilebag = TileBag()
sidebar = SideBar()
player = CompetitionBot(tilebag, game_board, sidebar, wordlist, 2, "bordpositie", word_dict)
bot = CompetitionBot(tilebag, game_board, sidebar, wordlist, 1, "bordpositie", word_dict)
